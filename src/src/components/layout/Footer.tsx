          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-20 mb-16">
            ...
            <div className="flex flex-col gap-5 max-w-sm">
              <div className="flex items-center gap-3 group cursor-default">
                <div className="w-10 h-10 bg-white/5 border border-white/10 flex items-center justify-center rounded-sm transition-colors group-hover:border-white/20">
                   <span className="font-headline text-xl font-black italic text-white">P</span>
                </div>
                <div className="flex flex-col">
                  <h2 className="font-headline text-3xl font-black italic text-white leading-none tracking-tighter uppercase">PANGEA</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-16 w-full lg:w-auto">
              ...
              <div className="flex flex-col gap-5">
                ...
                <ul className="flex flex-col gap-3 font-mono text-[11px] font-semibold text-white/50">
                  ...
                  <li className="hover:text-white cursor-pointer transition-colors">Contacto Editorial</li>
