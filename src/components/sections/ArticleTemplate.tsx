        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-32 space-y-8">
            ...
            <div className="p-8 border-l-2 border-pangea-primary bg-zinc-900/20">
               ...
               <p className="text-xs text-zinc-400 leading-relaxed italic">"Toda la información técnica presentada ha sido verificada bajo los estándares de PanGGea Lab."</p>
            </div>
          </div>
        </aside>
      </main>
